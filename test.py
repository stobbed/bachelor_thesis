...
if __name__ == '__main__':
    ...
    try:
        ...
        # pricnt(error.traceback)  # traceback of the function
...
#     p = multiprocessing.Process(target=bar(number))
#     p.start()
...
#         liste.append(randint(5,25))
   

#     pool = multiprocessing.Pool(3)
#     processes = [pool.apply_async(proc, args = (number, )) for number in liste]
