...
xmlpath_nw = os.path.join(path, simulationname + '.output_network.xml.gz')
xmlpath_evts = os.path.join(path, simulationname + '.output_events.xml.gz')
xmlpath_vehicles = os.path.join(path, simulationname + '.drt_vehicles.xml.gz')
