...
# vehicles_drt, vehicles_nondrt = scale_scenario_electric_conversion(reference_info)
# openlca.lifecycleassessment(vehicles_drt, vehicles_nondrt, getsimulationname(path_reference))
# openlca.lifecycleassement_reference_electro(vehicles_nondrt, getsimulationname(path_reference))
